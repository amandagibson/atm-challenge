...
describe Person do
    ...
    subject { described_class.new(name: 'Per') }
    ...
    describe ' can create an Account' do
        ...
        it ' 5. of Account class ' do
            expect(subject.account).to be_an_instance_of Account
        end

        it '6. with himself as an owner' do
    ...
    describe ' can manage funds if an account been created' do
        ...
        it '7. can deposit funds' do
          expect(subject.deposit(100)).to be_truthy
        end

        it '8. funds are added to the accounst balance - deducted from cash' do
            subject.cash = 100
            subject.deposit(100)
